    ...
    function TabProto() {
        ...
        this.add     = function(tab) {
            var fileName = tab.name,
                contains = isContains(tabsList, 'name', fileName);
        ...
        this.remove  = function(fileName) {
            var contains = isContain(tabsList, 'name', fileName);
        ...
        this.contains = function(path) {
            return isContains(tabsList, 'path', path);
        };

        function isContains(tabsList, propertyName, propertyValue) {
